#!/bin/bash
#SBATCH --job-name=selective_frozen
#SBATCH --partition=edith
#SBATCH --gres=gpu:8
#SBATCH --cpus-per-gpu=2
#SBATCH --time=3-00:00:00
#SBATCH --output=/ubc/cs/research/shield/projects/kren04/MD_DETR_runs/selective_softmax_null_bgloss_frozen_qf/slurm_%j.log
